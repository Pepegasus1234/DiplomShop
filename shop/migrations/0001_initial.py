# Generated by Django 5.1.4 on 2025-02-10 20:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('bottoms', 'Низ'), ('underwear', 'Нижнее белье'), ('tops', 'Верх'), ('headwear', 'Голова')], max_length=20, verbose_name='Категория')),
                ...
                ('image1', models.ImageField(upload_to='products/', verbose_name='Изображение 1')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='shop_users_permissions', to='auth.permission', verbose_name='user permissions')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='shop.chat', verbose_name='Чат')),
